...
model_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'pretrained_models_data')
...
keypoints_spec = [
    ...
    {'name': 'left upper chest', 'parent': 'upper chest', 'smpl_indx': 13, 'hradius': 0.12},
    {'name': 'left shoulder', 'parent': 'left upper chest', 'smpl_indx': 16, 'hradius': 0.10},
    ...
    {'name': 'right upper chest', 'parent': 'upper chest', 'smpl_indx': 14, 'hradius': 0.12},
    {'name': 'right shoulder', 'parent': 'right upper chest', 'smpl_indx': 17, 'hradius': 0.10},
    {'name': 'right elbow', 'parent': 'right shoulder', 'smpl_indx': 19, 'hradius': 0.10},
